 ...
 *
 */
public class Rsa256Signature extends AbstractSignature {
	
	private static final Logger logger = LoggerFactory.getLogger(Rsa256Signature.class);

	public Rsa256Signature(String privateKey, String charset) {
	...
	public String sign(String content) {
		try {
			...
			java.security.Signature signature = java.security.Signature
					.getInstance(ApiConstants.SIGN_SHA256RSA_ALGORITHMS);
			...
			logger.error("Rsa256 signature error,RSAcontent:{},charset:{}", content, charset);
